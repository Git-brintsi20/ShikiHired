...
\resumeSubHeadingListStart
    \resumeSubItem{Core Web Technologies}{HTML, CSS, JavaScript, TypeScript, React.js, Next.js 14/15, Bootstrap, TailwindCSS, Responsive Web Design, Cross-browser Compatibility}
    \resumeSubItem{Backend Development}{Node.js, Express.js, Python (limited ML: scikit-learn, pandas), Flask, REST API Development, Database Design}
    \resumeSubItem{Frameworks}{React.js, Next.js, MERN Stack, WordPress, Shopify, PWA Development, Laravel}
    \resumeSubItem{Database Management}{PostgreSQL, MongoDB, Firebase Firestore, Prisma ORM, Redis, Database Optimization, Query Performance Tuning}
    \resumeSubItem{Web Development Tools}{VS Code, Git/GitHub, Postman, Chrome DevTools, npm, Docker, CI/CD, Composer, WordPress Dashboard, cPanel}
    ...
    \resumeSubItem{Security \& DevOps}{JWT Authentication, REST APIs, WebSocket, API Integration, Agile Development}
    \resumeSubItem{ML \& AI (Relevant to HealthyMe, PlantZ)}{Data Preprocessing, scikit-learn, pandas, basic classification/regression, API integration for ML inference}
